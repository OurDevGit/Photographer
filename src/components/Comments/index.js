      ...
      commentslist.push(
        <Comment>
          ...
          <Comment.Content>
            ...
            <Comment.Actions>
              <Comment.Action>
                <a id={comment.id} onClick={this.handleClickReply}>
                  Reply
                </a>
              </Comment.Action>
            </Comment.Actions>
            ...
            <Comment className="commitText">
              ...
              <Comment.Content>
                <TextArea
                  ...
                  onChange={this.handleChangeReplyComment}
                />
          ...
          {replies.length > 0 ? <Comment.Group>{replies}</Comment.Group> : null}
        </Comment>
      );
    });
    return (
      <>
        {this.state.isLoading ? (
          ...
          <Comment.Group className="CommentList">{commentslist}</Comment.Group>
        )}
      </>
    );
  }
