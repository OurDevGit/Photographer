                ...
                <Grid.Column>
                  <Menu borderless className="desktop-menu-style">
                    <Menu.Item position="left" style={style.noPaddingStyle}>
                      <Menu.Item
                        name="TO_BE_SUBMITTED"
                        active={this.state.activeMenuItem === "TO_BE_SUBMITTED"}
                      ...
                      <Menu.Item
                        name="SUBMITTED"
                        active={this.state.activeMenuItem === "SUBMITTED"}
                        onClick={this.handleMenuItemClick}
                      >
                      ...
                      <Menu.Item
                        className=""
                        name="ACCEPTED"
                        active={this.state.activeMenuItem === "ACCEPTED"}
                        onClick={this.handleMenuItemClick}
                      >
                        Accepted({this.state.total.accepted})
                      </Menu.Item>
                      <Menu.Item
                        className="ReviewedMenu"
                        name="REJECTED"
                        active={this.state.activeMenuItem === "REJECTED"}
                        onClick={this.handleMenuItemClick}
                      >
