...
function stepsAnimation() {
  anime({
    ...
    complete() {
      document.querySelector(".step1 .green-wave-circle").style.borderColor =
        "#FF01010255";
      anime({
  ...
  anime({
    ...
    easing: "easeInOutQuad",
    complete() {
      document.querySelector(".step2 .green-wave-circle").style.borderColor =
        "#FF01010255";
      anime({
  ...
  anime({
    ...
    complete() {
      ...
      const waveCirclestyle = waveCircle
        ? waveCircle.style
        : { borderColor: "" };
...
export function removeInvestAnime() {
  ...
  document.querySelectorAll(".step .grey-circle").forEach((item) => {
