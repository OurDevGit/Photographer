...
class ResetPassword extends Component{
  ...
  ResetPassword(){
    ...
    .then(response=>{
      ...
      notification.success({
        ...
        description: "Successfully reset your password. Please Login with your new password",
      });
    })
    .catch(error=>{
      console.log(error)
      ...
      notification.error({
        message: 'Photoing App',
        description: "Sorry! There are some wrong problems. Please check your network and try again",
      });
    })
  }
  ...
  render(){
    ...
    var tmpTokenLabel =  this.props.location.search.split('=')[0].substr(1);
    if(!this.props.location.search || this.props.location.search == "" || tmpTokenLabel != "tmpToken")
    {
      return(
        <>
        </>
      ...
      return(
        <Grid textAlign='center' style={{ height: '100vh' }} verticalAlign='middle' className="ResetPassPage">
