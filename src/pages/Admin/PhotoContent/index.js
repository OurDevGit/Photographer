...
class PhotoContent extends Component {
    ...
    if (total > 0) {
      var zoomImage = [
        <div className="zoomImage">
          <PanAndZoomImage src={e.photo.url_fr} />
        </div>,
      ];
      this.setState({
        photo: e.photo,
  ...
  render() {
    ...
    if (this.props.status === "list_submitted_photos") {
      ...
      buttonGroup = [
        <Button.Group>
          ...
          <Button.Or />
          <Button negative onClick={this.handleRedeemClick}>
            Redeem
          </Button>
        </Button.Group>,
      ];
      ...
      this.state.photo.authorizations.forEach((authorization, Index) => {
        releases.push(
          ...
          >
            ...
            <Modal.Content image>
              <PanAndZoomImage src={authorization.documentUrl} />
    ...
    return (
      <div
        className={visible ? "admin_photo visible" : "admin_photo disable"}
        id="PhotoContent"
      >
        <Grid>
          <Grid.Row>
              ...
              {this.state.photo ? (
                <Grid verticalAlign="middle">
                    ...
                    <Grid.Column width="6">
                      <div className="photoDetail">
                        ...
                        <p>
                          ...
                          <b>
                            {" "}
                            Has {this.state.photo.authorizations.length} model
                            release
                          </b>
                        </p>
                        <p>
                  ...
                  <Grid.Row className="GridRow">
                    ...
                    <Grid.Column
                      className="actionButtonGroup buttonGroup"
                      width="5"
                    >
                      <p>
                        <span>IG ADMIN LINK:</span>
                        <Input placeholder="IG ADMIN LINK" />
                      </p>
                      Rating:
                      <Rating
                        maxRating={10}
                    ...
                    <Grid.Column
                      className="next_prevButtonGroup buttonGroup"
                      width="6"
                    >
                      <Button
                        content="Prev"
